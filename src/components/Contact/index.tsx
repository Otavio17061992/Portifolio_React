    ...
    <ContainerContact id="contato">
      ...
      <SubContainerContact>
        ...
        <BoxCV
          ...
          download="Gabriel Barbosa - Currículo"
        >
          <Icon
            width="30"
            height="30"
        ...
        <ContainerSocialMedias>
          <SocialMedia
            target="blank"
            href="https://www.linkedin.com/in/otavio17061992/"
          >
            <Icon
              width="30"
              height="30"
          ...
          <SocialMedia target="blank" href="https://github.com/Otavio17061992">
            <Icon
              width="30"
              height="30"
              viewBox="0 0 30 30"
          ...
          <SocialMedia
            target="blank"
            href="https://www.instagram.com/programerjon.ocx"
          >
            <Icon
              xmlns="http://www.w3.org/2000/svg"
              width="30"
